...
namespace {
kolodkin_g_multiplication_matrix_all::SparseMatrixCRS GenMatrix(
...
kolodkin_g_multiplication_matrix_all::SparseMatrixCRS GenMatrix(
  ...
  kolodkin_g_multiplication_matrix_all::SparseMatrixCRS a((int)num_rows, (int)num_cols);
...
TEST(kolodkin_g_multiplication_matrix__task_all, test_pipeline_run) {
  srand(time(nullptr));
  kolodkin_g_multiplication_matrix_all::SparseMatrixCRS a(400, 400);
  kolodkin_g_multiplication_matrix_all::SparseMatrixCRS b(400, 400);
  ...
  // Create Task
  auto test_task_all = std::make_shared<kolodkin_g_multiplication_matrix_all::TestTaskALL>(task_data_all);
...
TEST(kolodkin_g_multiplication_matrix__task_all, test_task_run) {
  srand(time(nullptr));
  kolodkin_g_multiplication_matrix_all::SparseMatrixCRS a(400, 400);
  kolodkin_g_multiplication_matrix_all::SparseMatrixCRS b(400, 400);
  std::vector<Complex> in = {};
