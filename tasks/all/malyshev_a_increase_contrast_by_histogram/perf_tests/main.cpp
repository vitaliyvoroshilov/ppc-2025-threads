...
TEST(malyshev_a_increase_contrast_by_histogram_all, test_pipeline_run) {
  ...
  auto test_task_all = std::make_shared<malyshev_a_increase_contrast_by_histogram_all::TestTaskALL>(task_data_all);
...
TEST(malyshev_a_increase_contrast_by_histogram_all, test_task_run) {
  constexpr int kCount = 150000000;
