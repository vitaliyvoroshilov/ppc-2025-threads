...
TEST(solovev_a_ccs_mmult_sparse_all, test_pipeline_run) {
  ...
  solovev_a_matrix_all::MatrixInCcsSparse m2(rows, 1);
  solovev_a_matrix_all::MatrixInCcsSparse m3(rows, 1);
  ...
  auto test_task_sequential = std::make_shared<solovev_a_matrix_all::SeqMatMultCcs>(task_data_seq);
...
TEST(solovev_a_ccs_mmult_sparse_all, test_task_run) {
  boost::mpi::communicator world;
