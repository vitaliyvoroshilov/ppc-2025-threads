...
TEST(smirnov_i_radix_sort_simple_merge_stl, test_pipeline_run) {
  ...
  // Create Task
  auto test_task_stl = std::make_shared<smirnov_i_radix_sort_simple_merge_stl::TestTaskSTL>(task_data_stl);
...
TEST(smirnov_i_radix_sort_simple_merge_stl, test_task_run) {
  constexpr int kCount = 10000000;
