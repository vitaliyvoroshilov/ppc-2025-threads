...
TEST(gnitienko_k_strassen_alg_stl, test_pipeline_run) {
  size_t size = 1024;
  ...
  // Create Task
  auto test_task_stl = std::make_shared<gnitienko_k_strassen_algorithm_stl::StrassenAlgSTL>(task_data_stl);
...
TEST(gnitienko_k_strassen_alg_stl, test_task_run) {
  size_t size = 1024;
