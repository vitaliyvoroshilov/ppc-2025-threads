...
TEST(korotin_e_crs_multiplication_stl, test_pipeline_run) {
  ...
  // Create Task
  auto test_task_stl = std::make_shared<korotin_e_crs_multiplication_stl::CrsMultiplicationSTL>(task_data_stl);
...
TEST(korotin_e_crs_multiplication_stl, test_task_run) {
  const unsigned int n = 900;
