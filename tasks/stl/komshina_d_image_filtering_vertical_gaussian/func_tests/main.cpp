...
TEST(komshina_d_image_filtering_vertical_gaussian_stl, SinglePixelImage) {
  std::size_t width = 1;
  std::size_t height = 1;
  ...
  komshina_d_image_filtering_vertical_gaussian_stl::TestTaskSTL test_task(task_data);
...
TEST(komshina_d_image_filtering_vertical_gaussian_stl, EmptyImage) {
  std::size_t width = 0;
  std::size_t height = 0;
...
TEST(komshina_d_image_filtering_vertical_gaussian_stl, Small2x2Image) {
  std::size_t width = 2;
  std::size_t height = 2;
...
TEST(komshina_d_image_filtering_vertical_gaussian_stl, SingleRowImage) {
  std::size_t width = 3;
  std::size_t height = 1;
...
TEST(komshina_d_image_filtering_vertical_gaussian_stl, ZeroWidthImage) {
  std::size_t width = 0;
  std::size_t height = 3;
  std::vector<unsigned char> in = {255, 255, 255};
  std::vector<float> kernel = {1, 1, 1, 1, 1, 1, 1, 1, 1};
...
TEST(komshina_d_image_filtering_vertical_gaussian_stl, ValidationInvalidOutputSize) {
  std::size_t width = 3;
  std::size_t height = 3;
  std::vector<unsigned char> in = {255, 255, 255};
  std::vector<float> kernel = {1, 1, 1, 1, 1, 1, 1, 1, 1};
...
TEST(komshina_d_image_filtering_vertical_gaussian_stl, PostProcessingCorrectness) {
  std::size_t width = 2;
  std::size_t height = 2;
  std::vector<unsigned char> in = {100, 150, 200, 50, 100, 150, 200, 250, 100, 150, 200, 50};
  std::vector<float> kernel = {1, 2, 1, 2, 4, 2, 1, 2, 1};
...
TEST(komshina_d_image_filtering_vertical_gaussian_stl, RandomImage) {
  std::size_t width = 5;
  std::size_t height = 5;
...
TEST(komshina_d_image_filtering_vertical_gaussian_stl, RandomImage2) {
  std::size_t width = 17;
