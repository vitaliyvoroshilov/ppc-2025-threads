...
TEST(kalyakina_a_Shell_with_simple_merge_stl, test_pipeline_run) {
  // Create data
  ...
  // Create Task
  auto test_task_stl = std::make_shared<kalyakina_a_shell_with_simple_merge_stl::ShellSortSTL>(task_data_stl);
...
TEST(kalyakina_a_Shell_with_simple_merge_stl, test_task_run) {
  // Create data
  std::vector<int> in = CreateReverseSortedVector(3000000, -1500000);
  std::vector<int> out(in.size());
