...
TEST(petrov_o_vertical_image_filtration_stl, test_pipeline_run) {
  ...
  // Create Task
  auto test_task_stl = std::make_shared<petrov_o_vertical_image_filtration_stl::TaskSTL>(task_data_stl);
...
TEST(petrov_o_vertical_image_filtration_stl, test_task_run) {
  constexpr int kCount = 5000;
