...
void RunPerfTest() {
  ...
  auto task = std::make_shared<polikanov_v_rectangles::TaskSTL>(task_data, function);
...
TEST(polikanov_v_rectangles_stl, test_pipeline_run) { RunPerfTest<true>(); }

TEST(polikanov_v_rectangles_stl, test_task_run) { RunPerfTest<false>(); }
