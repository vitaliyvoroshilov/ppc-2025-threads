...
TEST(kapustin_i_jarv_alg_stl, test_pipeline_run) {
  ...
  auto test_task_stl = std::make_shared<kapustin_i_jarv_alg_stl::TestTaskSTL>(task_data_stl);
...
TEST(kapustin_i_jarv_alg_stl, test_task_run) {
  constexpr int kCount = 10000000;
