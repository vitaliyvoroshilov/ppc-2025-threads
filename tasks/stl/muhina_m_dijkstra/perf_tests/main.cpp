...
TEST(muhina_m_dijkstra_stl, test_pipeline_run) {
  ...
  auto test_task_stl = std::make_shared<muhina_m_dijkstra_stl::TestTaskSTL>(task_data_stl);
...
TEST(muhina_m_dijkstra_stl, test_task_run) {
  constexpr size_t kNumVertices = 5000;
  size_t start_vertex = 0;
