...
TEST(laganina_e_component_labeling_stl, test_pipeline_run) {
  ...
  // Create Task
  auto test_task_omp = std::make_shared<laganina_e_component_labeling_stl::TestTaskSTL>(task_data_omp);
...
TEST(laganina_e_component_labeling_stl, test_task_run) {
  constexpr int kCount = 2000;
