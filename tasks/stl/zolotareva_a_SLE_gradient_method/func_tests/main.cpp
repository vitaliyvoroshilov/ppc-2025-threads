...
TEST(zolotareva_a_sle_gradient_method_stl, invalid_input_sizes) {
  int n = 2;
...
TEST(zolotareva_a_sle_gradient_method_stl, non_symmetric_matrix) {
  int n = 2;
...
TEST(zolotareva_a_sle_gradient_method_stl, not_positive_definite_matrix) {
  int n = 2;
...
TEST(zolotareva_a_sle_gradient_method_stl, negative_definite_matrix) {
  int n = 2;
...
TEST(zolotareva_a_sle_gradient_method_stl, zero_dimension) {
  std::vector<double> a;
  std::vector<double> b;
  std::vector<double> x;
...
TEST(zolotareva_a_sle_gradient_method_stl, singular_matrix) {
  int n = 2;
...
TEST(zolotareva_a_sle_gradient_method_stl, zero_vector_solution) {
  int n = 2;
...
TEST(zolotareva_a_sle_gradient_method_stl, n_equals_one) {
  int n = 1;
...
TEST(zolotareva_a_sle_gradient_method_stl, test_correct_answer1) {
  int n = 3;
...
TEST(zolotareva_a_sle_gradient_method_stl, Test_Image_random_n_3) { Form(3); };
TEST(zolotareva_a_sle_gradient_method_stl, Test_Image_random_n_5) { Form(5); };
TEST(zolotareva_a_sle_gradient_method_stl, Test_Image_random_n_7) { Form(7); };
TEST(zolotareva_a_sle_gradient_method_stl, Test_Image_random_n_20) { Form(591); };
