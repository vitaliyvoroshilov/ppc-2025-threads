...
void RunPerfTest() {
  ...
  auto task = std::make_shared<polikanov_v_rectangles::TaskOMP>(task_data, function);
...
TEST(polikanov_v_rectangles_omp, test_pipeline_run) { RunPerfTest<true>(); }

TEST(polikanov_v_rectangles_omp, test_task_run) { RunPerfTest<false>(); }
