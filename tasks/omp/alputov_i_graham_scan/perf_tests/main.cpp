...
namespace {
void GenerateTestData(std::vector<alputov_i_graham_scan_omp::Point>& data) {
...
TEST(alputov_i_graham_scan_omp, test_pipeline_run) {
  ...
  auto task = std::make_shared<alputov_i_graham_scan_omp::TestTaskOMP>(task_data);
...
TEST(alputov_i_graham_scan_omp, test_task_run) {
  std::vector<alputov_i_graham_scan_omp::Point> input;
  GenerateTestData(input);
  std::vector<alputov_i_graham_scan_omp::Point> output(input.size());
