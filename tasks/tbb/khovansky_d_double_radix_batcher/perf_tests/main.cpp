...
TEST(khovansky_d_double_radix_batcher_tbb, test_pipeline_run) {
  ...
  // Create Task
  auto test_task_tbb = std::make_shared<khovansky_d_double_radix_batcher_tbb::RadixTBB>(task_data_tbb);
...
TEST(khovansky_d_double_radix_batcher_tbb, test_task_run) {
  constexpr int kCount = 1000000;
