...
TEST(petrov_o_vertical_image_filtration_tbb, test_pipeline_run) {
  ...
  // Create Task
  auto test_task_sequential = std::make_shared<petrov_o_vertical_image_filtration_tbb::TaskTBB>(task_data_tbb);
...
TEST(petrov_o_vertical_image_filtration_tbb, test_task_run) {
  constexpr int kCount = 5000;
