...
TEST(kapustin_i_jarv_alg_tbb, test_pipeline_run) {
  ...
  auto test_task_tbb = std::make_shared<kapustin_i_jarv_alg_tbb::TestTaskTBB>(task_data_tbb);
...
TEST(kapustin_i_jarv_alg_tbb, test_task_run) {
  constexpr int kCount = 10000000;
